...
//javac -cp _build/ TestBundle.java && java -cp .:_build/ TestBundle
...
public class TestBundle
{
	...
	{
		TestBundle t=new TestBundle(args);
	}

	public TestBundle(String[] args) throws Exception
	{
		ar.add(33);
		ar.add("last arg");
...
//			portOut.send(ob9);
	...
	}// end TestBundle constructor (run test)
}//end class TestBundle
//EOF
